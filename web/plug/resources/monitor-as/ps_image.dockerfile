...
RUN mkdir -p /var/local/cDistro/plug/resources/monitor-as/
ADD http://10.1.26.2:7000/plug/resources/monitor-as/common.sh /var/local/cDistro/plug/resources/monitor-as/common.sh
